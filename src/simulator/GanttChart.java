...
public class GanttChart {
    // gantt chart
    private static int ganttX = 50 ; // start drawing point on x-coordinate
    private static final int ganttY = 473; // Gantt location on y-coordinate 
    ...
    public static void clear(){
         List.clear();
         ganttX = 50;  // start location on x-coordinate
