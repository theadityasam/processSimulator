...
public class MyTable extends AbstractTableModel{
    ...
    private final Queue tableQueue ;  // job queue for the table
    private final String[] columnNames = {"#","Arrive","Burst","Priority","Start","Wait" , "Remain" ,"Finish" , "Turn" , "%"}; // table header
